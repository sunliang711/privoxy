var proxy = 'PROTOCOL UPSTREAM';
var direct = 'DIRECT';
function FindProxyForURL(url, host){
    for (var i = 0; i < blockedHost.length; i++){
        if (dnsDomainIs(host, blockedHost[i])){
            return proxy
        }
        // if (blockedHost[i].startsWith(".")){
        //     if (dnsDomainIs(host, blockedHost[i])){
        //         return proxy
        //     }
        // }else{
...
//REF https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/startsWith
